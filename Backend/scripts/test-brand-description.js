...
async function main() {
    ...
    if (resFree.statusCode === 403) {
        ...
        console.error(`❌ FAILURE: FREE user got ${resFree.statusCode}`, resFree.body);
    }
    // 3. Upgrade to PRO
    ...
    if (resPro.body?.description === "I am a PRO brand and this is my story.") {
        ...
        console.error(`❌ FAILURE: PRO user update failed. Status: ${resPro.statusCode}`, resPro.body);
    }
    // Cleanup
...
//# sourceMappingURL=test-brand-description.js.map