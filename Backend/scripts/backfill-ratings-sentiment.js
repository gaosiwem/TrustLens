...
async function inferSentiment(text) {
...
async function backfillRatingSentiment() {
    console.log("🔍 Fetching ratings with comments that don't have sentiment analysis...\n");
    ...
    for (const rating of ratings) {
        ...
        console.log(`🧠 Analyzing Rating: "${rating.stars} stars - ${rating.comment?.slice(0, 30)}..."`);
        try {
            ...
            console.log(`   ✅ ${sentiment.label} (score: ${sentiment.score.toFixed(2)}, urgency: ${sentiment.urgency}%)`);
...
//# sourceMappingURL=backfill-ratings-sentiment.js.map