...
async function main() {
    ...
    try {
        ...
        if (emailSent) {
            ...
            console.warn("⚠️ NO EMAIL SENT. Check if any brands matched the PRO/VERIFIED criteria.");
            ...
            console.log("DEBUG: Found Active Subs:", subs.map((s) => `${s.brand.name} (${s.planId})`));
        }
    }
    catch (err) {
