...
async function main() {
    ...
    if (!brand) {
        console.log(`❌ Brand "${brandName}" not found. Run simulation scripts first.`);
        return;
    }
    console.log(`🚀 Simulating Trust History for brand: ${brandName} (${brand.id})`);
    ...
    for (const dp of dataPoints) {
        ...
        console.log(`✅ Created score: ${dp.score} for ${evaluatedAt.toISOString()} (${dp.trend})`);
    }
...
//# sourceMappingURL=simulate-trust-history.js.map