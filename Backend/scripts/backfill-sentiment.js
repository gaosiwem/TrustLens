...
async function backfillSentiment() {
    ...
    const analyzedComplaintIds = new Set(existingEvents.map((e) => e.complaintId));
    ...
    const complaints = allComplaints.filter((c) => !analyzedComplaintIds.has(c.id));
...
//# sourceMappingURL=backfill-sentiment.js.map