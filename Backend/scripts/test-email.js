...
async function main() {
    ...
    const { EmailTransport } = await import("../src/services/email/emailTransport.js");
    const { EmailTemplates } = await import("../src/services/email/emailTemplates.js");
    ...
    try {
        ...
        const welcomeEmail = EmailTemplates.getWelcomeEmail("Gaosiwem", "https://trustlens.com/verify?token=12345");
        ...
        const resetEmail = EmailTemplates.getPasswordResetEmail("https://trustlens.com/reset-password?token=abcdef");
        await EmailTransport.send({
            to: recipient,
        ...
        const resolvedEmail = EmailTemplates.getNotificationEmail({
            ...
            reviewRating: 5,
            reviewComment: "Thank you for the quick turnaround! Very helpful support team.",
        });
        await EmailTransport.send({
            to: recipient,
        ...
        const invitationEmail = EmailTemplates.getBrandInvitationEmail("TechSolutions Inc.", "12345");
        await EmailTransport.send({
            to: recipient,
