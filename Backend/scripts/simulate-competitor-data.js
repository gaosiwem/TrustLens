...
async function main() {
    ...
    for (let i = 0; i < 15; i++) {
        const text = "My TV arrived with a cracked screen. Delivery guy just dropped it.";
    ...
    console.log("✅ Simulation complete. Checkers and Takealot now have vulnerabilities.");
}
main()
    .catch((e) => {
    console.error(e);
...
//# sourceMappingURL=simulate-competitor-data.js.map