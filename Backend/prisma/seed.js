    ...
    const brandsData = [
        {
            ...
            isVerified: true,
            description: "Looking for the BEST EXPERIENCE in motoring and the commitment to always put your needs first, visit one of our 5 beautiful dealerships, with over 800+ vehicles in stock you’ll be sure to find your dream car.",
        ...
        {
            name: "Checkers",
            logoUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/87/Checkers_Logo.svg/1200px-Checkers_Logo.svg.png",
            isVerified: true,
            description: "Better and Better. Your favorite grocery retailer offering high quality food, appliances and household goods.",
        ...
        {
            name: "FNB",
            logoUrl: "https://upload.wikimedia.org/wikipedia/en/4/4b/First_National_Bank_Logo.png",
            isVerified: true,
            description: "First National Bank - How can we help you? Leading financial services provider in South Africa.",
        ...
        {
            name: "Takealot",
            logoUrl: "https://upload.wikimedia.org/wikipedia/commons/4/42/Takealot_Logo.png",
            isVerified: true,
            description: "South Africa's largest online retailer. Shop for everything from cellphones to electronics.",
        ...
        {
            name: "Vodacom",
            logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Vodacom_Logo.svg/2560px-Vodacom_Logo.svg.png",
            isVerified: false,
            description: "South Africa's leading cellular network provider. Connecting you to the world.",
    ...
    const complaintsData = [
        {
            ...
            description: "Found the car I wanted online, visited the Pretoria campus and the team helped me through everything. Highly recommended!",
            status: ComplaintStatus.RESOLVED,
            stars: 5,
            comment: "Best experience I've had at a dealership.",
            aiSummary: "The customer had a seamless buying experience at the Pretoria dealership and highly recommends their services.",
            sentimentScore: 0.95,
            replied: true,
            replyContent: "Thank you John! We are so glad you found your dream car with us. See you for your first service!",
        },
        {
            brandIdx: 0,
            title: "Slight delay in paperwork",
            description: "Bought a used Audi. The car is great but the registration took two weeks longer than promised.",
            status: ComplaintStatus.RESOLVED,
            stars: 3,
            comment: "Car is good, paperwork was slow.",
            aiSummary: "The customer is satisfied with the vehicle quality but frustrated by delays in the registration process.",
            sentimentScore: 0.4,
            replied: true,
            replyContent: "Hi Sarah, we apologize for the backlog at the licensing department. We're glad the Audi is treating you well!",
        },
        {
            brandIdx: 1, // Checkers
            title: "Sixty60 delivered late and items missing",
            description: "Ordered groceries for a dinner party, the driver was an hour late and the salmon was missing.",
            status: ComplaintStatus.RESPONDED,
            stars: 2,
            comment: "Terrible experience with Sixty60 today.",
            aiSummary: "A delivery failure resulted in missing essential items and delayed service for a time-sensitive event.",
            sentimentScore: -0.6,
            replied: true,
            replyContent: "We are deeply sorry for the inconvenience. We've credited your account for the salmon and a voucher for your next shop.",
        },
        {
            brandIdx: 2, // FNB
            title: "App is constantly crashing",
            description: "Ever since the last update, the FNB app closes immediately after login. I can't pay my bills!",
            status: ComplaintStatus.UNDER_REVIEW,
            stars: 1,
            comment: "Fix the app!",
            aiSummary: "The customer is experiencing critical application failures preventing essential banking operations.",
            sentimentScore: -0.8,
            replied: false,
        },
        {
            ...
            description: "Ordered a 65 inch TV, when I unboxed it the screen was shattered. Courier just left it at my door.",
            status: ComplaintStatus.RESOLVED,
            stars: 1,
            comment: "Broken on arrival.",
            aiSummary: "The customer received a high-value fragile item in damaged condition due to poor handling/delivery.",
            sentimentScore: -0.9,
            replied: true,
            replyContent: "Hi Mike, we've arranged for the damaged TV to be picked up today and a replacement is being express shipped. Sorry for the frustration!",
        },
        {
            brandIdx: 3,
            title: "Fast delivery of my airfryer",
            description: "Ordered on Monday night, arrived Tuesday morning. Amazing service as always.",
            status: ComplaintStatus.RESOLVED,
            stars: 5,
            comment: "Always reliable.",
            aiSummary: "The customer is highly satisfied with the ultra-fast delivery turnaround time.",
            sentimentScore: 0.9,
            replied: false,
        },
    ];
